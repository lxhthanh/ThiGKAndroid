...
public class ChangeInfoAsyncTask extends AsyncTask<String,Boolean, JSONObject> {
    private Map<String,String> mMap;
    private com.example.demoapirequestapplication.IHolder.ILoginView mLoginView;
    public ChangeInfoAsyncTask(ILoginView iLoginView, Map<String, String> map){
        this.mMap = map;
